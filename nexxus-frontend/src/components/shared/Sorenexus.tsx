...
export default function Sorenexus() {
    ...
    if (!isOpen) return (
        <div className="fixed bottom-32 right-10 z-[200] ai-avatar scale-75 md:scale-100 flex items-center justify-center bg-accent text-black rounded-full w-14 h-14 cursor-pointer shadow-2xl" onClick={() => setIsOpen(true)}>
    ...
    return (
        <div className="fixed bottom-32 right-6 md:right-10 z-[200] flex flex-col items-end gap-5">
