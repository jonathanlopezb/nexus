export default function MobileDock() {
    return (
        <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[360px] h-[70px] bg-black/90 backdrop-blur-2xl border border-white/10 rounded-full flex items-center justify-around px-2 z-[150] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <a href="#" className="flex flex-col items-center text-accent transition-all hover:scale-110">
            ...
            <a href="#" className="flex flex-col items-center opacity-40 hover:opacity-100 transition-all hover:scale-110">
            ...
            <div className="relative -mt-10 group">
                ...
                <div className="relative w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,255,194,0.3)] cursor-pointer hover:scale-110 transition-transform font-space-grotesk font-black text-black text-xl italic border-4 border-black">
