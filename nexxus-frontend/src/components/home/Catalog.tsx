        ...
        <section className="max-w-7xl mx-auto px-6 md:px-10 py-20 border-t border-white/5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
                {isLoading ? (
                    ...
                    <div className="glass-card p-6 md:p-8 group cursor-pointer relative">
                        ...
                        <div className="mt-8 space-y-3">
                            ...
                            <h4 className="text-2xl md:text-3xl font-black uppercase tracking-tighter italic">React Infinity</h4>
                            <div className="flex flex-col pt-2">
                                <span className="text-xs md:text-sm line-through opacity-40 font-bold">$250</span>
                                <span className="text-3xl md:text-4xl font-black italic">$189.00</span>
                            </div>
